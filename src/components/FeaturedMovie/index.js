                ...
                <div className="featuredHorizontal">
                    ...
                    <div className="featuredInfo">
                        ...
                        <div className="featuredButtons">
                            <a href={`/watch/${item.id}`} className="featuredWatchbutton">► Play </a>
                            <a href={`/list/add/${item.id}`} className="featuredMoreInfo">More Info</a>
                        </div>
                        <div className="featuredGenres">Genres: <strong> {genres.join(', ')} </strong></div>
